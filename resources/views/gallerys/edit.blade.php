...
@section('gallery')
    <div class="panel-body">
        <form class="form-horizontal form-bordered" method="post"
            action="{{ route('updateGallery', ['id' => $gallery->id]) }}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="file" id="inputReadOnly" class="form-control" name="image" value="{{ $gallery->image }}">
                </div>
            </div>
